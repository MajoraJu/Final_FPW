export class Phase3 extends Phaser.Scene {
    ...
    preload(){
        ...
        this.load.audio('deadLocked','/juegofinal/game/assets/sounds/nivel3.mp3');
    ...
    create(){
        ...
        api.fetchObstacles(3,'BOTTOM').then( response =>{
        ...
        api.fetchObstacles(3,'SIDE').then( response =>{
            this.spikes = this.physics.add.group();
    ...
    setNivel()
    {
        this.deadLockedSound = this.sound.add('deadLocked');
        this.deadLockedSound.play();
